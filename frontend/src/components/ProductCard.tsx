  ...
  return (
    <div className="flex flex-col flex-1 shrink self-stretch my-auto basis-0 ">
      <div className="flex flex-col flex-auto">
        <div className=" relative justify-between min-h-[364px]">
          <img
            loading="lazy"
            src={image}
            alt={name}
            className="object-cover absolute  size-full rounded-md"
          />
        ...
        <p>
          {" "}
          <span className="text-text-destructive">${salePrice}</span>{" "}
          <span className="line-through text=[#414E62]">${originalPrice}</span>
        </p>
      </div>
    </div>
  );
