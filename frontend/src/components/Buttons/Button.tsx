...
interface Props {
  ...
  theme: "destructive-secondary" | "secondary" | "primary" | "destructive-primary" | "link" | "destructive-link";
  ...
  return (
    <div
      className={`inline-flex items-center rounded-[var(--spacing-tokens-radius-radius-xxs)] justify-center relative ${
        ...
        (state.size === "medium" && state.state === "hover" && state.theme === "secondary") ||
        (state.size === "small" && state.state === "hover" && state.theme === "secondary") ||
        (state.size === "x-small" && state.state === "hover" && state.theme === "secondary") ||
        (state.state === "normal" && state.theme === "secondary")
          ...
          : state.theme === "secondary" && state.state === "hover" && state.size === "large"
        ...
        state.size === "small" && state.theme === "destructive-link" && ["disabled", "hover"].includes(state.state)
          ? "gap-[var(--primitive-spacers-0)]"
          : "gap-[var(--primitive-spacers-8)]"
      } ${
        ["destructive-primary", "destructive-secondary", "primary", "secondary"].includes(state.theme)
        ...
        (state.size === "large" && state.theme === "secondary")
          ...
          : (state.size === "medium" && state.theme === "destructive-primary") ||
            (state.size === "medium" && state.theme === "destructive-secondary") ||
          ...
          : (state.size === "x-small" && state.theme === "destructive-primary") ||
            (state.size === "x-small" && state.theme === "destructive-secondary") ||
        ...
        state.theme === "primary" && state.state === "normal"
          ...
          : state.state === "normal" && ["destructive-secondary", "secondary"].includes(state.theme)
          ...
          : state.theme === "destructive-secondary" && ["disabled", "hover"].includes(state.state)
          ? "bg-semantic-button-button-destructive-secondary-hover"
          : state.state === "disabled" && ["primary", "secondary"].includes(state.theme)
    ...
    >
      <div
        className={`w-fit whitespace-nowrap relative ${
          state.size === "large" && state.theme === "destructive-link" && ["hover", "normal"].includes(state.state)
            ? "font-paragraph-medium-regular"
            : state.size === "x-small"
            ? "font-paragraph-xsmall-regular"
            : "font-paragraph-small-regular"
        } ${
          ["destructive-link", "destructive-primary", "destructive-secondary", "link", "primary"].includes(state.theme)
            ? "mt-[-1.00px]"
            : ""
        } ${
          state.size === "large" && state.theme === "destructive-link" && ["hover", "normal"].includes(state.state)
          ...
          (state.state === "normal" && state.theme === "primary")
            ...
            : (state.state === "disabled" && state.theme === "destructive-primary") ||
              (state.state === "hover" && state.theme === "destructive-secondary") ||
              (state.state === "normal" && state.theme === "destructive-link") ||
              (state.state === "normal" && state.theme === "destructive-secondary")
      ...
      >
        {((state.size === "large" && state.state === "disabled" && state.theme === "link") ||
          (state.size === "large" && state.state === "disabled" && state.theme === "primary") ||
          (state.size === "large" && state.state === "normal" && state.theme === "link") ||
          (state.size === "large" && state.state === "normal" && state.theme === "primary") ||
          (state.size === "large" && state.theme === "destructive-link") ||
          (state.size === "large" && state.theme === "destructive-primary") ||
          (state.size === "large" && state.theme === "destructive-secondary") ||
          (state.size === "large" && state.theme === "secondary") ||
          (state.size === "medium" && state.state === "disabled") ||
          (state.size === "medium" && state.state === "hover" && state.theme === "destructive-link") ||
          (state.size === "medium" && state.state === "hover" && state.theme === "destructive-primary") ||
          (state.size === "medium" && state.state === "hover" && state.theme === "destructive-secondary") ||
          (state.size === "medium" && state.state === "hover" && state.theme === "secondary") ||
          (state.size === "medium" && state.state === "normal") ||
          (state.size === "small" && state.state === "disabled" && state.theme === "link") ||
          (state.size === "small" && state.state === "disabled" && state.theme === "primary") ||
          (state.size === "small" && state.state === "disabled" && state.theme === "secondary") ||
          (state.size === "small" && state.state === "hover" && state.theme === "secondary") ||
          (state.size === "small" && state.state === "normal" && state.theme === "link") ||
          (state.size === "small" && state.state === "normal" && state.theme === "primary") ||
          (state.size === "small" && state.theme === "destructive-link") ||
          (state.size === "small" && state.theme === "destructive-primary") ||
          (state.size === "small" && state.theme === "destructive-secondary") ||
          (state.size === "x-small" && state.state === "disabled" && state.theme === "link") ||
          (state.size === "x-small" && state.state === "disabled" && state.theme === "primary") ||
          (state.size === "x-small" && state.state === "normal" && state.theme === "link") ||
          (state.size === "x-small" && state.state === "normal" && state.theme === "primary") ||
          (state.size === "x-small" && state.theme === "destructive-link") ||
          (state.size === "x-small" && state.theme === "destructive-primary") ||
          (state.size === "x-small" && state.theme === "destructive-secondary") ||
          (state.size === "x-small" && state.theme === "secondary") ||
          (state.state === "hover" && state.theme === "link") ||
          (state.state === "hover" && state.theme === "primary")) && <>{children}</>}

        {state.theme === "secondary" && state.size === "small" && state.state === "normal" && <>Cancel</>}
      </div>
    </div>
  );
};
